...
class EhConfig {
  ...
  const EhConfig({
    ...
    this.enableAnime4K,
    this.anime4KScaleFactor,
    this.anime4KPushStrength,
    this.anime4KPushGradStrength,
    this.enableAnime4KForNetwork,
  });
  ...
  final double? anime4KScaleFactor;
  final double? anime4KPushStrength;
  final double? anime4KPushGradStrength;
  /// 是否对网络图片（在线浏览）启用 Anime4K 超分辨率
  final bool? enableAnime4KForNetwork;
  ...
  factory EhConfig.fromJson(Map<String,dynamic> json) => EhConfig(
    ...
    enableAnime4K: json['enableAnime4K'] != null ? bool.tryParse('${json['enableAnime4K']}', caseSensitive: false) ?? false : null,
    anime4KScaleFactor: json['anime4KScaleFactor'] != null ? double.tryParse('${json['anime4KScaleFactor']}') ?? 2.0 : null,
    anime4KPushStrength: json['anime4KPushStrength'] != null ? double.tryParse('${json['anime4KPushStrength']}') ?? 0.31 : null,
    anime4KPushGradStrength: json['anime4KPushGradStrength'] != null ? double.tryParse('${json['anime4KPushGradStrength']}') ?? 1.0 : null,
    enableAnime4KForNetwork: json['enableAnime4KForNetwork'] != null ? bool.tryParse('${json['enableAnime4KForNetwork']}', caseSensitive: false) ?? false : null
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    'enableAnime4K': enableAnime4K,
    'anime4KScaleFactor': anime4KScaleFactor,
    'anime4KPushStrength': anime4KPushStrength,
    'anime4KPushGradStrength': anime4KPushGradStrength,
    'enableAnime4KForNetwork': enableAnime4KForNetwork
  };
  ...
  EhConfig copyWith({
    ...
    Optional<bool?>? enableAnime4K,
    Optional<double?>? anime4KScaleFactor,
    Optional<double?>? anime4KPushStrength,
    Optional<double?>? anime4KPushGradStrength,
    Optional<bool?>? enableAnime4KForNetwork
  }) => EhConfig(
